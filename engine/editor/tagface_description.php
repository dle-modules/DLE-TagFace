...
$(function(){
    ...
    <textarea name="description" id="description" style="width:98%;height:300px;">{$tagFace['description']}</textarea></div></div>
HTML;
}
...
function tag_typograf() {
    ...
    <textarea name="description" id="description" class="wysiwygeditor" style="width:98%;height:300px;">{$tagFace['description']}</textarea></div></div>
HTML;
}
