...
$(function(){
    ...
    <textarea name="description_pages" id="description_pages" style="width:98%;height:300px;">{$tagFace['description_pages']}</textarea></div></div>
HTML;
}
...
function tag_typograf() {
    ...
    <textarea name="description_pages" id="description_pages" class="wysiwygeditor" style="width:98%;height:300px;">{$tagFace['description_pages']}</textarea></div></div>
HTML;
}
